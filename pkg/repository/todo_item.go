...
func (r *TodoItemRepository) Create(listId int, item todo_go.TodoItem) (int, error) {
	tx, err := r.db.Begin()
	if err != nil {
		return 0, err
	}
...
func (r *TodoItemRepository) Update(userId, itemId int, input todo_go.UpdateItemInput) error {
